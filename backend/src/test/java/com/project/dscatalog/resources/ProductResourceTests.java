 ...
 */
@WebMvcTest(value = ProductResource.class, excludeAutoConfiguration = {SecurityAutoConfiguration.class}) // adicionado o mehtodo(excludeAutoConfiguration), para ignorar as configurações de segurança.
